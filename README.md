...
1. Clone this repository to your desired folder:
   ...
   ```sh
   git clone https://github.com/tan12082001/Project-Human-Clinic-Database.git
   ```
...
```sh
  createdb human_clinic
  psql -U your_username -d huma_clinic -a -f database/schema_based_on_diagram.sql
